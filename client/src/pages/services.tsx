        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center mb-16">
            <h1 className="text-3xl lg:text-5xl font-bold mb-6">
              Nossos <span className="text-vermelho">Serviços</span>
            </h1>
          ...
          {/* Methodology Section */}
          <div className="bg-gradient-to-r from-verde/5 to-azul/5 rounded-2xl p-8 lg:p-12">
            <h2 className="text-2xl lg:text-3xl font-bold mb-8 text-center">
              Nossa <span className="text-verde">Metodologia</span>
            </h2>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="bg-vermelho text-white p-4 rounded-full mx-auto mb-4 w-16 h-16 flex items-center justify-center">
              ...
              <div className="text-center">
                <div className="bg-verde text-white p-4 rounded-full mx-auto mb-4 w-16 h-16 flex items-center justify-center">
              ...
              <div className="text-center">
                <div className="bg-azul text-white p-4 rounded-full mx-auto mb-4 w-16 h-16 flex items-center justify-center">
              ...
              <div className="text-center">
                <div className="bg-roxo text-white p-4 rounded-full mx-auto mb-4 w-16 h-16 flex items-center justify-center">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-3">
                    <div className="text-vermelho mt-1">
